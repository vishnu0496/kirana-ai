...
function smartParse(message: string): any {
  ...
  // 3. INVENTORY — BUG 2 FIX: handle standalone stock/list/etc
  ...
  // 5. BULK ADD — "add 10 soaps 5 chips 3 oil" (must come before single add)
  ...
  // 6. FIND NUMBER + ITEM in message (core of natural language parsing)
  // Number-First: "10 mysore sandal"
  ...
  // 7. SUPPORT NUMBER-LAST FORMAT ("mysore sandal 10")
...
app.post("/api/webhook/whatsapp", async (req, res) => {
  ...
  // 2. PARSE MESSAGE (Handle Multi-Line)
